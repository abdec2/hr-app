...
const EditModal = () => {
    ...
    const handleReset = () => {
        ...
        setValue("status", statusOptions[statusOptions.findIndex(option => option.value === store.selectedCr?.status)]['value'])
    }
                    ...
                    <Row className='gy-1 pt-75'>
                        <Col md={6} xs={12}>
                            ...
                            <Controller
                                ...
                                name='location'
                                render={({ field }) => (
                                    <Input id='location' placeholder='Branch Area' invalid={errors.location && true} defaultValue={store.selectedCr?.location} onChange={value => setValue('location', value.target.value)} />
                                )}
                            />
                        </Col>
                        <Col md={6} xs={12}>
                            ...
                            <Controller
                                ...
                                name='cr'
                                render={({ field }) => (
                                    <Input id='cr' placeholder='Enter CR Number' invalid={errors.cr && true} defaultValue={store.selectedCr?.cr} onChange={value => setValue('cr', value.target.value)} />
                                )}
                            />
                        </Col>
                        <Col xs={12}>
                            ...
                            <Controller
                                ...
                                render={({ field }) => (
                                    ...
                                    defaultValue={store.selectedCr?.expiry} />
                                )}
                            />
                        </Col>
                            ...
                            <Controller
                                ...
                                render={({ field }) => (
                                    <Input
                                        ...
                                        onChange={value => setValue('employeesNo', value.target.value)}
                                    />
                                )}
                            />
                            ...
                            <Controller
                                ...
                                render={({ field }) => (
                                    <Select
                                        ...
                                        defaultValue={statusOptions[statusOptions.findIndex(option => option.value === store.selectedCr?.status)]}
